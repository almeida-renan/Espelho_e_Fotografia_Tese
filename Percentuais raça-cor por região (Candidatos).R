...
# Percentuais de raça/cor nas regiões (Candidatos)

#Este script contém o passo a passo para criar os gráficos 5.1 e 5.2, que mostram
# a distribuição percentual de candidatos por raça (auto e heteroclassificada) e região
...
# Gráfico de linha com anos e regiões
...
# Salvar no caminho desejado usando o ggsave
ggsave("Percentuais Autodeclaração Regiões (Candidatos).png",bg = "white", dpi = 300, width = 8, height = 6)
...
# Gráfico heteroclassificação

tudojuntoHetero <- tudojuntoHetero %>%
  mutate(Cor = str_to_title(Cor.final2))
...
# Salvando
ggsave("Percentuais Heteroclassificação Regiões (Candidatos).png",bg = "white", dpi = 300, width = 8, height = 6)
