...
# Percentuais raça-cor por gênero (eleitos)

# Este script contém o passo a passo para criar o gráfico 5.9, que mostra
# a distribuição percentual de eleitos por raça (auto e heteroclassificada) e gênero
...
#Salvando
ggsave("Percentuais Auto e Hetero Gênero (Eleitos).png",bg = "white", dpi = 300, width = 8, height = 6)
