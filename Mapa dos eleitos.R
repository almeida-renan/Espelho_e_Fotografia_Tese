...
# Mapa do percentual de eleitos brancos

# Este script contém o passo a passo para gerar a Figura 2, que mostra o percentual de
# eleitos brancos por UF do Brasil, segundo a autodeclaração e a heteroclassificação, 
# nas eleições de 2014, 2018 e 2022.

# Obs: a única diferença entre este script e "Mapa dos candidatos" é o filtro utilizado para
# considerar apenas os eleitos
...
# Salvando o mapa
ggsave("Mapa Eleitos.png",bg = "white", dpi = 300, width = 8, height = 6)
