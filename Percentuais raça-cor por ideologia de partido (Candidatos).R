...
# Percentuais raça-cor por ideologia de partido

# Este script contém o passo a passo para criar o gráfico 5.5, que mostra
# a distribuição percentual de candidatos por raça (auto e heteroclassificada) e ideologia
...
ggsave("Percentuais Auto e Hetero Ideologia Partido (Candidatos).png",bg = "white", dpi = 300, width = 8, height = 6)
